    ...
    fn exec(&mut self, ins: u16) {
        ...
        match ins & 0xf000 {
            ...
            0xF000 => match ins & 0x00ff {
                0x07 => self.getdt((ins & 0xf00 >> 8) as u8),
                0x0A => self.waitkp((ins & 0xf00 >> 8) as u8),
                0x15 => self.setdt((ins & 0xf00 >> 8) as u8),
                0x18 => self.setst((ins & 0xf00 >> 8) as u8),
                0x1E => self.addi((ins & 0xf00 >> 8) as u8),
                0x29 => self.setisprite((ins & 0xf00 >> 8) as u8),
                0x33 => self.setbcd((ins & 0xf00 >> 8) as u8),
                0x55 => self.regsstore((ins & 0xf00 >> 8) as u8),
                0x65 => self.regsload((ins & 0xf00 >> 8) as u8),
                _ => return,
            }
